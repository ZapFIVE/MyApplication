...
public class IndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    * 以便其他调用
    */
    private OnPageScrollListener mPageChangeListener;
    ...
    private void initIndicator() {
        ...
        linePaint.setColor(Color.parseColor("#7D55FF"));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawLine((mWidth / 2 - mContextWidth / 2 + getPaddingLeft()),
                getHeight() / 2,
                (mWidth / 2 + mContextWidth / 2 - getPaddingRight()),
                getHeight() / 2, linePaint);
        /*
    ...
    public void setOnPageChangeListener(OnPageScrollListener mPageChangeListener) {
        this.mPageChangeListener = mPageChangeListener;
    }

    @Override
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        Log.d("onPageScrolled", "========" + position + ",===offset" + positionOffset);
        if (mSmooth) {
